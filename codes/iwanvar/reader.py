...
class Dataset(object):
    ...
    def next_batch(self, batch_size):
        ...
        passage_masks = torch.LongTensor(passage_masks)
        passage_lens = torch.LongTensor(passage_lens)
        titles = torch.LongTensor(titles)
        title_masks = torch.LongTensor(title_masks)
        title_lens = torch.LongTensor(title_lens)
        questions = torch.LongTensor(questions)
        question_masks = torch.LongTensor(question_masks)
        question_lens = torch.LongTensor(question_lens)
